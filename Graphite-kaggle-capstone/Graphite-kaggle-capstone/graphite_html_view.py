...
from PySide6.QtCore import QRectF, Qt, Signal, QPoint
from PySide6.QtGui import QPainter, QColor, QBrush, QPen, QPainterPath, QCursor
...
class HtmlViewNode(QGraphicsObject, HoverAnimationMixin):
    ...
    @property
    def text(self):
        """Returns the HTML source code content."""
    ...
    def _setup_ui(self):
        ...
        self.render_button.setIcon(qta.icon('fa5s.play', color=text_color))
