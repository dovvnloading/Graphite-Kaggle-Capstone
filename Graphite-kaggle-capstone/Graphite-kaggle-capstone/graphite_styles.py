...
class StyleSheet:
    ...
    MONOCHROMATIC_THEME = """
        ...
        QTextEdit { background-color: #2a2a2a; color: #d4d4d4; border: 1px solid #444444; border-radius: 4px; padding: 8px; selection-background-color: #4a4a4a; }
    """
...
DARK_FRAME_COLORS = {
    ...
    "Teal Header": {"color": "#1abc9c", "type": "header"}
}
...
MONO_FRAME_COLORS = {
    ...
    "Teal Header": {"color": "#7f7f7f", "type": "header"}
}
